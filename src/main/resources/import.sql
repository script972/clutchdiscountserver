...
INSERT INTO clutchdatabase.company(title, position_id, city_id, logo, web_site, scores, available) VALUES ('ДП Адидас Украина', 1, 1, 'maxresdefault.jpg', 'https://www.adidas.net.ua/', 12, TRUE );
INSERT INTO clutchdatabase.company(title, position_id, city_id, logo, web_site,scores, available) VALUES ('RodiMood', 2, 1, 'FIocltU.jpg', 'http://odessaua.com.ua/?70730', 17, TRUE );
